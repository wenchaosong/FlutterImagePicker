...
class FilePicker {
  ...
  static const String rootRouteName = "flutter_image_picker";
  ...
  ///   当用户取消时返回一个空数组
  ///
  ///   [imagePathList] 一旦设置 则 [pickType]参数无效
  ///
  ...
  ///
  ///   when [imagePathList] is not null , [pickType] invalid
  ///
  ...
  Future<List<AssetEntity>> _pickAsset(
    ...
    List<AssetPathEntity> imageList,
    List<AssetEntity> pickedAssetList,
  ) async {
