...
import '../../../src/engine/throttle.dart';
import '../../../src/entity/options.dart';
import '../../../src/provider/asset_provider.dart';
import '../../../src/provider/config_provider.dart';
import '../../../src/provider/gallery_list_provider.dart';
import '../../../src/provider/i18n_provider.dart';
import '../../../src/provider/selected_provider.dart';
import '../../../src/ui/dialog/change_gallery_dialog.dart';
import '../../../src/ui/page/photo_preview_page.dart';
...
class _PhotoMainPageState extends State<PhotoMainPage>
  ...
  Future<void> _refreshListFromWidget() async {
    _onRefreshAssetPathList(widget.photoPathList);
  }
